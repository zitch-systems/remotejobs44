...
//
// Pure UI: top bar, nav links, theme toggle, user dropdown, mobile menu.
// All auth-sync side effects (validating the Supabase session, listening
// for TOKEN_REFRESHED / SIGNED_OUT, fetching the profile row, writing
// into useAuthStore) live in components/providers/AuthSyncProvider.tsx
// and run exactly once per session. The Header just subscribes to
// Zustand for `user / isLoggedIn / isAdmin / hydrated` and renders.
        ...
        <div className="flex items-center gap-2 ml-auto">
          ...
          {mounted && (
            <button
              ...
              className="w-11 h-11 flex items-center justify-center rounded-lg border border-slate-200 dark:border-[#1e3a5f] text-slate-500 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-[#0a1628] transition-all"
            >
