...
const CATS: Cat[] = [
  {
    slug: 'engineering', name: 'Engineering', count: '2,140', bg: '#eff6ff', fg: '#2563eb',
    icon: <><polyline points="16 18 22 12 16 6" /><polyline points="8 6 2 12 8 18" /></>,
  },
  {
    slug: 'design', name: 'Design', count: '840', bg: '#faf5ff', fg: '#9333ea',
    icon: <><circle cx="13.5" cy="6.5" r="2.5" /><circle cx="6.5" cy="12.5" r="2.5" /><circle cx="17" cy="17" r="2.5" /><path d="M12 9l-3 2M15 15l-1-3" /></>,
  },
  {
    slug: 'marketing', name: 'Marketing', count: '1,300', bg: '#fdf2f8', fg: '#db2777',
    icon: <><path d="M3 11l18-5v12L3 14v-3z" /><path d="M11.6 16.8a3 3 0 1 1-5.8-1.6" /></>,
  },
  {
    slug: 'data', name: 'Data & AI', count: '920', bg: '#ecfeff', fg: '#0891b2',
    icon: <><path d="M3 3v18h18" /><path d="M7 14l4-4 3 3 5-6" /></>,
  },
  {
    slug: 'finance', name: 'Finance', count: '610', bg: '#fffbeb', fg: '#d97706',
    icon: <><line x1="12" y1="1" x2="12" y2="23" /><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6" /></>,
  },
  {
    slug: 'operations', name: 'Customer Support', count: '1,070', bg: '#fff7ed', fg: '#ea580c',
  ...
  {
    slug: 'hr', name: 'People & HR', count: '430', bg: '#eef2ff', fg: '#4f46e5',
    icon: <><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2" /><circle cx="9" cy="7" r="4" /><path d="M23 21v-2a4 4 0 0 0-3-3.87M16 3.13a4 4 0 0 1 0 7.75" /></>,
  },
  {
    slug: 'sales', name: 'Sales', count: '780', bg: '#fff1f2', fg: '#e11d48',
        ...
        <div className="cat-grid">
          {CATS.map(c => (
            ...
            >
              ...
              <span className="cc"><b>{c.count}</b> open roles</span>
            </Link>
          ))}
        </div>
      </div>
