...
<div style="max-width:560px;margin:40px auto;background:#fff;border-radius:12px;overflow:hidden;box-shadow:0 2px 8px rgba(0,0,0,0.06)">
  <div style="background:#0a5c36;padding:32px 40px">
  ...
  <div style="padding:40px">
    ...
    <a href="${process.env.NEXT_PUBLIC_APP_URL}/jobs" style="display:inline-block;background:#0a5c36;color:#fff;text-decoration:none;padding:14px 28px;border-radius:8px;font-weight:600;font-size:15px">Browse Jobs →</a>
    <hr style="border:none;border-top:1px solid #e7e5e4;margin:32px 0">
    <p style="margin:0;color:#a8a29e;font-size:13px">To apply to any job, upgrade from <strong>₦1,000</strong>. <a href="${process.env.NEXT_PUBLIC_APP_URL}/pricing" style="color:#0a5c36">See plans →</a></p>
  </div>
</div>
</body></html>`,
  };
...
<div style="max-width:560px;margin:40px auto;background:#fff;border-radius:12px;overflow:hidden;box-shadow:0 2px 8px rgba(0,0,0,0.06)">
  ...
  <div style="padding:40px">
    ...
    <a href="${process.env.NEXT_PUBLIC_APP_URL}/dashboard" style="display:inline-block;background:#0a5c36;color:#fff;text-decoration:none;padding:14px 28px;border-radius:8px;font-weight:600;font-size:15px">Go to Dashboard →</a>
    <hr style="border:none;border-top:1px solid #e7e5e4;margin:32px 0">
    <p style="margin:0;color:#a8a29e;font-size:13px">Need help? <a href="${process.env.NEXT_PUBLIC_APP_URL}/contact" style="color:#0a5c36">Contact us</a></p>
  </div>
</div>
</body></html>`,
  };
  ...
  const jobRows = jobs.slice(0, 5).map(j => `
    <tr>
      <td style="padding:12px 0;border-bottom:1px solid #f5f5f4">
        <a href="${process.env.NEXT_PUBLIC_APP_URL}/jobs/${j.id}" style="color:#0a5c36;font-weight:600;text-decoration:none;font-size:14px">${j.title}</a>
...
<div style="max-width:560px;margin:40px auto;background:#fff;border-radius:12px;overflow:hidden;box-shadow:0 2px 8px rgba(0,0,0,0.06)">
  ...
  <div style="padding:40px">
    ...
    <div style="margin-top:24px">
      <a href="${process.env.NEXT_PUBLIC_APP_URL}/jobs" style="display:inline-block;background:#0a5c36;color:#fff;text-decoration:none;padding:14px 28px;border-radius:8px;font-weight:600;font-size:15px">View All Jobs →</a>
    </div>
    <hr style="border:none;border-top:1px solid #e7e5e4;margin:32px 0">
    <p style="margin:0;color:#a8a29e;font-size:12px">You're receiving this because you have job alerts enabled. <a href="${process.env.NEXT_PUBLIC_APP_URL}/profile" style="color:#0a5c36">Manage alerts</a></p>
  </div>
</div>
</body></html>`,
  };
