    ...
    <div className="max-w-[720px] mx-auto px-5 py-14">
      ...
      <div className="mb-8">
        ...
        <h1 className="font-display font-extrabold text-3xl text-stone-900 dark:text-stone-100 tracking-tight mb-4">
          How to Find Remote Jobs in Nigeria in 2026
        </h1>
      ...
      <div className="job-prose space-y-6">
        {[
          ...
          { h: 'Best platforms to find remote jobs', p: 'RemoteJobs44 aggregates 70,000+ remote jobs from top companies. We Work Remotely, Remote.co, and Remotive list vetted remote positions. LinkedIn remote filter and Greenhouse/Lever ATS boards at specific companies are excellent sources for mid-to-senior roles.' },
      ...
      <div className="mt-12 card p-6 bg-brand-50 dark:bg-brand-900/10 border-brand-200 dark:border-brand-800">
        ...
        <p className="text-stone-500 dark:text-stone-400 text-sm mb-4">Browse 70,000+ remote jobs. Access from ₦500.</p>
