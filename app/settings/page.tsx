    ...
    if (cookiePresent) return (
      <div className="max-w-[500px] mx-auto px-5 py-20 text-center">
        ...
        <div className="flex items-center justify-center gap-3 flex-wrap">
          ...
          <Link href="/login?next=/settings" className="inline-flex items-center gap-2 px-6 py-3 border border-stone-200 dark:border-[#1e3a5f] text-stone-600 dark:text-stone-300 font-bold rounded-lg hover:bg-stone-50 dark:hover:bg-[#162033] transition-colors">
            Sign in again
          </Link>
        </div>
      </div>
