    ...
    const html = `
      <div style="font-family:sans-serif;max-width:600px;margin:0 auto;padding:24px">
        ...
        <table style="width:100%;border-collapse:collapse">
          <tr><td style="padding:6px 0;color:#64748b;width:100px">From</td><td style="padding:6px 0;font-weight:600;color:#1e293b">${safeName}</td></tr>
          <tr><td style="padding:6px 0;color:#64748b">Email</td><td style="padding:6px 0"><a href="mailto:${safeEmail}" style="color:#1d4ed8">${safeEmail}</a></td></tr>
          <tr><td style="padding:6px 0;color:#64748b">Subject</td><td style="padding:6px 0;color:#1e293b">${subjectLine}</td></tr>
        </table>
        <hr style="border:none;border-top:1px solid #e2e8f0;margin:20px 0"/>
        <h3 style="color:#1e293b;margin-bottom:8px">Message</h3>
        <p style="color:#334155;line-height:1.7;white-space:pre-wrap">${safeMessage.replace(/</g, '&lt;').replace(/>/g, '&gt;')}</p>
        <hr style="border:none;border-top:1px solid #e2e8f0;margin:20px 0"/>
        <p style="color:#94a3b8;font-size:12px">Reply directly to this email to respond to ${safeName}.</p>
      </div>
    `;
