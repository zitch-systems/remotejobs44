...
export const metadata: Metadata = {
  ...
  description: 'Search 70,000+ remote jobs in engineering, design, marketing, finance and more. Filter by category, type, salary, and region. Apply from Nigeria and Africa.',
